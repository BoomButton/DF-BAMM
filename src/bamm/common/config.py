...
def _property_has_format_error(propkey, value):
    return (propkey not in properties.keys() or 
        (properties[propkey][0] == IS_DIR and os.path.exists(value) and not os.path.isdir(value)) or 
        (properties[propkey][0] == IS_FILE and os.path.exists(value) and not os.path.isfile(value)) or
